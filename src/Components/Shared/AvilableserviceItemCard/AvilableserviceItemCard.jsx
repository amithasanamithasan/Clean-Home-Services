...
const AvilableserviceItemCard = ({avil}) => {
  
    const { title,image,price,description}=avil;
    return (
      ...
      <div className="card-body">
          <h2 className="font-serif text-2xl font-extrabold rounded-lg text-red-500 bg-green-500 uppercase text-center">
              {title}
          </h2>
...
export default AvilableserviceItemCard;